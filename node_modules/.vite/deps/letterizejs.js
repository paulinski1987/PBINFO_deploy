...
var deconstructText = (node, wrapper, className) => {
  ...
  for (let n = 0; n < textLength; n++) {
    ...
    letterNode.textContent = text[n] === " " ? " " : text[n];
    node.before(letterNode);
    list.push(letterNode);
  }
  return list;
};
var deconstructObjects = (targets, target, wrapper, className, list, listAll, i, id) => {
...
var Letterize = class _Letterize {
  constructor(params) {
    ...
    _Letterize.numInstances = (_Letterize.numInstances || 0) + 1;
    const wrapper = params.wrapper || "span";
    const className = params.className;
    const id = _Letterize.numInstances;
    const list = [];
    const listAll = [];
...
var letterize_default = Letterize;
export {
  letterize_default as default
};
//# sourceMappingURL=letterizejs.js.map
