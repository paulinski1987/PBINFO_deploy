...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[0].dark);
      add_location(meta, file, 68, 2, 2055);
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("track" in $$props2)
      $$invalidate(3, track = $$props2.track);
    if ("defaultMode" in $$props2)
      $$invalidate(4, defaultMode = $$props2.defaultMode);
    if ("themeColors" in $$props2)
      $$invalidate(0, themeColors2 = $$props2.themeColors);
    if ("disableTransitions" in $$props2)
      $$invalidate(5, disableTransitions2 = $$props2.disableTransitions);
    if ("darkClassNames" in $$props2)
      $$invalidate(6, darkClassNames2 = $$props2.darkClassNames);
    if ("lightClassNames" in $$props2)
      $$invalidate(7, lightClassNames2 = $$props2.lightClassNames);
    if ("defaultTheme" in $$props2)
      $$invalidate(8, defaultTheme = $$props2.defaultTheme);
    if ("nonce" in $$props2)
      $$invalidate(9, nonce = $$props2.nonce);
    if ("themeStorageKey" in $$props2)
      $$invalidate(10, themeStorageKey2 = $$props2.themeStorageKey);
    if ("modeStorageKey" in $$props2)
      $$invalidate(11, modeStorageKey2 = $$props2.modeStorageKey);
  };
  $$self.$capture_state = () => ({
    onMount,
    defineConfig,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("modeStorageKey" in $$props2)
      $$invalidate(11, modeStorageKey2 = $$props2.modeStorageKey);
    if ("trueNonce" in $$props2)
      $$invalidate(1, trueNonce = $$props2.trueNonce);
  };
