...
var Fullpage = (e.fullpage = o(t, n), e.fullpage);
...
function instance($$self, $$props, $$invalidate) {
	let { options } = $$props, { skipInit = false } = $$props;
	let api;
	let fullpageEl;

	const events = EVENTS.reduce(
	...
	function div_binding($$value) {
		binding_callbacks[$$value ? "unshift" : "push"](() => {
			$$invalidate(0, fullpageEl = $$value);
		});
	}

	$$self.$set = $$props => {
		if ("options" in $$props) $$invalidate(1, options = $$props.options);
		if ("skipInit" in $$props) $$invalidate(2, skipInit = $$props.skipInit);
...
class Src extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { options: 1, skipInit: 2 });
	}
}
